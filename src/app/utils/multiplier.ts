...
const oneBombArr = [
  ...
  2.25, 2.47, 2.75, 3.09, 3.54, 4.12, 4.95, 6.19, 8.25, 12.38, 24.75,
];
...
const threeBombArr = [
  1.12, 1.29, 1.48, 1.71, 2.0, 2.35, 2.79, 3.35, 4.07, 5, 6.26, 7.96, 10.35,
...
const sevenBombArr = [
  1.37, 1.94, 2.79, 4.09, 6.14, 9.44, 14.95, 24.47, 41.6, 73.95, 138.66, 277.33,
  600.87, 1442.1, 3965.77, 13219.25, 59486.62, 475893,
];

const eightBombArr = [
  1.46, 2.18, 3.35, 5.26, 8.5, 14.17, 24.47, 44.05, 83.2, 166.4, 356.56, 831.98,
  2163.15, 6489.45, 23794.65, 118973.25, 1070759.25,
];
...
const thirteenBombArr = [
  2.06, 4.5, 10.35, 25.3, 66.41, 189.75, 600.87, 2163.15, 9193.39, 49031.4,
  367735.5, 5148297,
];

const fourteenBombArr = [
  2.25, 5.4, 13.8, 37.95, 113.85, 379.5, 1442.1, 6489.45, 36773.55, 294188.4,
  4412826,
];

const fifteenBombArr = [
  2.47, 6.6, 18.97, 59.64, 208.72, 834.9, 3965.77, 23794.65, 202254.52,
  3236072.4,
];

const sixteenBombArr = [
  2.75, 8.25, 27.11, 99.39, 417.45, 2087.25, 13219.25, 118973.25, 2022545.25,
];

const seventeenBombArr = [
  3.09, 10.61, 40.66, 178.91, 939.26, 6261.75, 59486.62, 1070759.25,
];

const eighteenBombArr = [3.54, 14.14, 65.06, 357.81, 2504.7, 25047, 475893];

const nineteenBombArr = [4.12, 19.8, 113.85, 834.9, 8766.45, 175329];

const twentyBombArr = [4.95, 29.7, 227.7, 2504.7, 52598.7];

const twentyOneBombArr = [6.19, 49.5, 569.25, 12523.5];
